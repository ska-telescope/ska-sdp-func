...
def test_sub_grid():
    ...
    vis = numpy.random.randn(num_times * num_baselines, num_channels) + \
    ...
    if cupy:
        ...
        grid_uvw_es(uvw_gpu, vis_gpu, weight_gpu, freq_gpu,
                    image_size, epsilon, cell_size_rad, w_scale, min_plane_w,
                    0, 0, sub_grid_w, full_grid
        )
        ...
        grid_uvw_es(uvw_gpu, vis_gpu, weight_gpu, freq_gpu,
                    image_size, epsilon, cell_size_rad, w_scale, min_plane_w,
                    sub_grid_start_u, sub_grid_start_v, sub_grid_w, sub_grid
        )

...
)
{
    ...
    sdp_mem_check_dims_and_shape_at(uvw, num_dims, uvw_shape, status, expr, func, file, line);
    
    if(
        !(*status) // if status is set do nothing
    ...
    sdp_mem_check_location_at(uvw, expected_location, status, expr, func, file, line);
...
)
{
    ...
    sdp_mem_check_dims_and_shape_at(vis, num_dims, vis_shape, status, expr, func, file, line);
    ...
    sdp_mem_check_location_at(vis, expected_location, status, expr, func, file, line);

...
/*       ********************************** */
/* Subroutine */ static inline int sdmn_(integer *m, integer *n, doublereal *c__,
...
/*       ********************************** */
/* Subroutine */ static inline int sckb_(integer *m, integer *n, doublereal *c__,
...
/*       ********************************** */
/* Subroutine */ static inline int aswfa_(integer *m, integer *n, doublereal *c__,
...
/*       ********************************** */
/* Subroutine */ static inline int segv_(integer *m, integer *n, doublereal *c__, integer *
...
static inline void _generate_pswf(int m, double c,
                                  num_t *pswf, int size, int stride)
{
 ...
 */
void sdp_generate_pswf(int m, double c, struct sdp_Mem *out,
                       sdp_Error* status)
{
    if (!status) return;
    ...
    case SDP_MEM_DOUBLE:
        _generate_pswf(m, c, static_cast<double *>(sdp_mem_data(out)), size, stride);
        break;
    case SDP_MEM_FLOAT:
        _generate_pswf(m, c, static_cast<float *>(sdp_mem_data(out)), size, stride);
        break;
    case SDP_MEM_COMPLEX_FLOAT:
        _generate_pswf(m, c, static_cast<std::complex<float> *>(sdp_mem_data(out)), size, stride);
        break;
    case SDP_MEM_COMPLEX_DOUBLE:
        _generate_pswf(m, c, static_cast<std::complex<double> *>(sdp_mem_data(out)), size, stride);
        break;
    default:

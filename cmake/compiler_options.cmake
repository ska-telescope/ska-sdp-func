...
if (NOT WIN32)
	...
	# Since explicit AVX instruction are only present in sdp_gridder_wtower_uvw.cpp source file,
	# we only turn on the relevant flags only for that file.
  	if ("${CMAKE_C_COMPILER_ID}" MATCHES "Intel.*")
        if(ENABLE_AVX512)
            if(HAS_AVX512)
                message(STATUS "Enabling explicit AVX512 instructions")
                set(SDP_GRIDDER_WTOWER_UVW_CPP_EXTRA_COMPILE_FLAGS
                "-D__AVX512F__;-xCORE-AVX512;-mavx512f;-mavx512cd;-mavx512bw;-mavx512dq;-mavx512vl;-mfma;-qopt-zmm-usage=high;-qopt-report=5")
            else()
        ...
        if(ENABLE_AVX2)
            if(HAS_AVX2)
                ...
                set(SDP_GRIDDER_WTOWER_UVW_CPP_EXTRA_COMPILE_FLAGS "-D__AVX2__;-xCORE-AVX2;-mavx2;-mfma;-qopt-zmm-usage=low;-qopt-report=5")
            else()
        ...
        if(ENABLE_PREFETCH)
            ...
            string(APPEND SDP_GRIDDER_WTOWER_UVW_CPP_EXTRA_COMPILE_FLAGS ";-D__PREFETCH__")
        endif()
